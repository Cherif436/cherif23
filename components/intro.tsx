  ...
  return (
    <section ref={ref} id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      <motion.div className="flex flex-col items-center justify-center gap-2 px-4 text-lg font-medium sm:flex-row" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, }}>
        ...
        <a className="flex items-center gap-2 py-3 transition bg-white border rounded-full outline-none cursor-pointer hover:bg-blue-50 group px-7 focus:scale-110 hover:scale-110 active:scale-105 border-blue/30 dark:bg-white/10" href="/cv_cherif_merzoud.pdf" download>
          Télécharger mon CV{" "}
            ...
            <div className="relative w-auto max-w-3xl mx-auto my-6">
              ...
              <div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                ...
                <div className="flex items-center justify-end p-6 bg-white border-t border-solid rounded-b border-blueGray-200 dark:bg-gray-800">
                  ...
                  <a className="px-6 py-3 mb-1 mr-1 text-sm font-bold text-white uppercase transition-all duration-150 ease-linear bg-blue-800 rounded-full shadow outline-none dark:bg-gray-900 bg-gradient-to-r active:bg-blue-900 hover:shadow-lg focus:outline-none" href="/cv_cherif_merzoud.pdf" download="CV.pdf"> Télécharger le CV</a>
                </div>
              </div>
            </div>
          </div>
