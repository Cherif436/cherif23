    ...
    <section ref={ref} id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      <div className="flex items-center justify-center">
        <div className='relative'>
          ...
          >
            <Image src={img} alt="Merzoud" width="192" height="192" quality="95" priority={true} className="clearfix h-24 w-24 rounded-full object-cover border-[0.35rem] border-white shadow-xl" />
          </motion.div>
        </div>
      </div>
              ...
              <div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                ...
                <div className="relative flex flex-auto p-6 bg-white justify-evenly dark:bg-gray-800">
                  <div className="col-span-12 p-2 rounded-lg sm:col-span-6 lg:col-span-4">
                    <Image src={img} alt="Merzoud" width="192" height="192" quality="95" priority={true} className="h-24 w-24 rounded-full object-cover border-[0.35rem] border-white shadow-xl clearfix" />
                  </div>
                  <div className="col-span-12 p-2 rounded-lg sm:col-span-6 lg:col-span-4">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none bg-gradient-to-t from-gray-200 to-transparent">
            <div className="relative w-auto mx-auto my-6 max-w-7xl">
              ...
              <div className="relative flex flex-col w-full bg-white border-0 rounded-lg outline-none focus:outline-none">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2521.125513963725!2d4.249381715806971!3d50.81031316925022!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c3c7000b8a84cb%3A0x1365cdb4cf0f9301!2sGroenstraat%208%2C%201602%20Sint-Pieters-Leeuw!5e0!3m2!1sfr!2sbe!4v1623345503633!5m2!1sfr!2sbe" width="350" height="350" style={{ border: 0 }} loading="lazy"></iframe>
              </div>
            </div>
          </div>
        </>
