  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <motion.div>
          <h5 className="flex my-3 text-2xl font-medium"><FaCode className="mr-2 dark:text-white" /> Langages</h5>
          <div className="my-2">
            {
        ...
        <motion.div>
          <h5 className="flex my-3 text-2xl font-medium"><FaTools className="mr-2 dark:text-white" /> Outils</h5>
          <div className="my-2">
            {
              tools.map(tool => <Bar data={tool} key={tool.name} />)
            }
          </div>
          <h5 className="flex my-3 mt-5 text-2xl font-medium"><FaDatabase className="mr-2 dark:text-white" /> Base de données</h5>
          <div className="my-2">
            {
